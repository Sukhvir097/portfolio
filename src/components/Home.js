  ...
  <div className="overlay" style={{ backgroundColor: 'rgba(0, 0, 0, 0.6)', height: '100%' }}>
    <div className="container h-100 d-flex align-items-center justify-content-center">
      <div className="row w-100 align-items-center">
        {/* Text Section */}
        <div className="col-12 col-md-6 text-white" data-aos="fade-right" data-aos-duration="1500">
        ...
        {/* Image Section */}
        <div className="col-12 col-md-6 text-center" data-aos="fade-left" data-aos-duration="1500">
          <img
            src={profileImg}
            alt="Sukhvir Singh"
